...
public @interface Matcher {
    ...
    /**
     * 针对不同场景下所需的匹配模式的不同，默认"_default_"，详见{@link WdConstant#DEFAULT_GROUP}
     * <p>
     * 该参数使用一般结合{@link Matchers}这个注解使用
     *
     * @return 分组
     */
    String[] group() default {WdConstant.DEFAULT_GROUP};
     ...
     *
     * <p>只有修饰类型为{@link CharSequence}的类及子类才会生效，否则抛出异常{@link WdException}
     *
     * @return 匹配的值是否为空字符
     */
